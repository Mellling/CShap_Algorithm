namespace _06.Heap
{
    internal class Program
    {
		 ...
		 * 힙 영역과 다른 개념 (스택은 같은 개념 맞음)
		 ******************************************************/

        // <힙 구현>
        // 힙은 노드들이 트리의 왼쪽부터 채운 완전이진트리를 구조로 가지며
        ...
        static void Main(string[] args)
        {
            ...
            queue.Enqueue("환자3 - 심장마비(1분 뒤)");

            while (queue.Count > 0) 
            {
                Console.WriteLine(queue.Dequeue());
            }
            // 큐 같은 경우 들어온 순서에 따라 진행하기 때문에 위급도에 따라 치료할 수 없다.

            PriorityQueue<string, int> pq = new PriorityQueue<string, int>();
            pq.Enqueue("환자1 - 감기(30년뒤)", 5);
            pq.Enqueue("환자2 - 타박상(60년뒤)", 8);
            pq.Enqueue("환자3 - 심장마비(1분 뒤)", 1);
            pq.Enqueue("환자4 - 교통사고(1분 뒤)", 3);
            pq.Enqueue("환자5 - 탈모", 9);
            ...
            // 큐와 거의 동일하게 사용. 우선순위가 붙으며 우선순위에 따라 정리한다.
            // 우선순위를 기준으로 우선순위가 높은 순서대로 꺼내 쓸 수 있는 기능 제공.
